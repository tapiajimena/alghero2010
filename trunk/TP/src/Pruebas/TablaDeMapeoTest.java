...
public class TablaDeMapeoTest extends TestCase {
	...
	public void testArmarTabla(){
	    ...
	    assertTrue(tabla.getTabla().get(2).getTiempo()==6);
	    assertTrue(tabla.getTabla().get(3).getTiempo()==8);
	    assertTrue(tabla.getTabla().get(4).getTiempo()==10);
	    assertTrue(tabla.getTabla().get(5).getTiempo()==12);
